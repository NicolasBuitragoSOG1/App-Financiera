  ...
  <div class="p-6">
    ...
    <div v-else class="space-y-6">
        ...
        <div class="card">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">${{ formatCurrency(financeStore.totalBalance) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">${{ formatCurrency(financeStore.overview?.monthly_income || 0) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">${{ formatCurrency(financeStore.overview?.monthly_expenses || 0) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">{{ formatPercentage(financeStore.overview?.savings_rate || 0) }}%</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="card">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">Accounts by Platform</h3>
          <div class="space-y-4">
            <div
            ...
            >
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  <p class="font-medium text-gray-900">{{ platformName }}</p>
                  <p class="text-sm text-gray-500">{{ platformData.accounts.length }} accounts</p>
                </div>
              </div>
              <div class="text-right">
                <p class="font-semibold text-gray-900">${{ formatCurrency(platformData.totalBalance) }}</p>
                <p class="text-sm text-gray-500 capitalize">{{ platformData.platform.platform_type }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-semibold text-gray-900">Financial Goals</h3>
          <router-link to="/goals" class="text-primary-600 hover:text-primary-700 text-sm font-medium">
            Manage goals
          </router-link>
        </div>
        <div v-if="financeStore.overview?.active_goals?.length === 0" class="text-center py-8">
          ...
          <p class="text-gray-500">No financial goals set yet</p>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <div class="flex items-center justify-between mb-2">
              <h4 class="font-medium text-gray-900">{{ goal.goal_name }}</h4>
